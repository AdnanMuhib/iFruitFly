...
class WekaMachineLearning(object):
    ...
    def weka_cross_validation(self, t_model, dataset_dir, type_loader):
        # start the vm
        #start_jvm()
        # open the test data
        test_data = self.load_dataset(dataset_dir, type_loader)
    ...
    def load_dataset(self, dir, type_loader):
        type_loader = "weka.core.converters." + type_loader 
        # opening the loader for Arff Reader
        loader = Loader(classname=type_loader)
    ...
    def output_prediction_to_an_array(self, classifier, test_data):
        ...
        for index, inst in enumerate(test_data):
            ...
            # changed this line because of wrong ouputs on first at tesseract 17/5/2017
