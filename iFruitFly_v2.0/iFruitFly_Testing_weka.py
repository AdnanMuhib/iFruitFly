...
##############################################################################################
def python_wrapper(mImage, prefix, file_name, pre_prefix, dir, permanent_dir, model): 
    ...
    demo_printing_picture(permanent_dir, prefix, mImage, pre_prefix, dir, file_name)
    ...
    features = iFruitFly_clustering.cluster_analysis.cluster_analysis(ir_directory, permanent_dir + "\\output_INFLO.csv", mat_directory, 
                                                                  dir + "\\" + file_name, 
                                                                  prefix, file_name, 
                                                                  permanent_dir)
    if (features == None):
...
##############################################################################################
# Running the Rapid Miner for Testing and Training
...
##############################################################################################
# Plotting the image for saving the plots
...
##############################################################################################
# Running any bat file via command line \ Basically being employed for rapid miner
...
if __name__ == "__main__":
    mImage = "J:\\iFruitFly\\Python Scripts\\Pictures_Day_1\\Galia_Case_A\\Galia_A_17.08.15_1200_RGB_1.png"
    prefix = "C:\\Users\\Abdullah_A\\Documents\\ifruitfly_temp\\temp_2017-01-26_06-58-57\\"
    pre_prefix = "C:\\Users\\Abdullah_A\\Documents\\ifruitfly_temp"
